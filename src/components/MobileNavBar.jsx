  ...
  return (
    <div className="flex  md:hidden navbar mt-1 w-full z-50">
      ...
      <div className="navbar-end flex items-center">
        <div
          className="btn custom-icon bg-cyan-900 text-white rounded-full p-2 hover:bg-cyan-800 transition duration-200 flex items-center justify-center cursor-pointer"
      ...
      {isOpen && (
        <div className=" absolute block top-16 right-0 w-48 bg-gray-50 font-bold shadow-lg rounded-l-lg z-50">
          ...
          <Link to="/gallery" className="block p-2 hover:bg-gray-200">
            Gallery
          </Link>
